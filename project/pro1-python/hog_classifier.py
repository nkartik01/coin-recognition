...
folder = "C:/users/aknar/documents/image procesing/project/dataset/try7"
...
document.save('Hog_result_ind3.docx')
...
clf = SVC(kernel='poly', random_state=0, coef0=0.5, probability=True)
clf.fit(pc, y_train_labels)
joblib.dump(clf, 'filename2.pkl', compress=0, protocol=None, cache_size=None)
print(clf)
"""
from sklearn.naive_bayes import GaussianNB
